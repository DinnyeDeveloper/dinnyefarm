...
function settingtoggle(){
  ...
  // Ez vált a dark és light mód között.
...
console.log('%c A weboldalt Dennyel Készítette. ', 'background-image: linear-gradient(90deg,#8000ff,#6bc5f8); color: white;font-weight:900;font-size:1rem; padding:20px;');
...
document.onkeydown = (e)=>{
    if (event.keyCode === 123 || ctrlShiftKey(e, 'I') || ctrlShiftKey(e, 'J') || ctrlShiftKey(e, 'C') || (e.ctrlKey && e.keyCode === 'U'.charCodeAt(0)))
        return false;
        console.log('%c Jó probálkozás. 😅 ', 'background-image: linear-gradient(90deg,#8000ff,#6bc5f8); color: white;font-weight:900;font-size:1rem; padding:20px;');
}
;
